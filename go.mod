module github.com/SpiffyEight77/porter
...
replace (
	get.porter.sh/magefiles => github.com/SpiffyEight77/magefiles v0.6.8
	get.porter.sh/porter => github.com/SpiffyEight77/porter v1.0.17
